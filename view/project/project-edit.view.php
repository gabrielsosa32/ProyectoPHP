            ...
            <div class="container">
                ...
                <form id="frm-project" action="?c=project&a=Save" method="post" enctype="multipart/form-data" class="p-5">
                    ...
                    <div class="form-group">
                        <label>Título</label>
                        <input type="text" name="project_titulo" value="<?php echo $project->project_titulo; ?>" class="form-control" required>
                    </div>
                    
                    <div class="form-group">
                        <label>Subtítulo</label>
                        <input type="text" name="project_subtitulo" value="<?php echo $project->project_subtitulo; ?>" class="form-control" required>
                    </div>
                    
                    <div class="form-group">
                        <label>Resumen</label>
                        <textarea name="project_resumen" form="frm-project" cols="30" rows="10" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="project_problematica" form="frm-project" cols="30" rows="10" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="project_interrogante" form="frm-project" cols="30" rows="10" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="project_objetivo" form="frm-project" cols="30" rows="10" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="project_solucion" form="frm-project" cols="30" rows="10" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="project_pruebayconclusion" form="frm-project" cols="30" rows="10" class="form-control">
                            <?php echo $project->project_pruebayconclusion; ?>
                        </textarea>
                    </div>

                    <div class="form-group">
                        <label>Integrantes - ATENCIÓN: ES NECESARIO QUE INGRESES TANTO TU PROPIO NOMBRE DE USUARIO SIN ERRORES COMO
                        EL DE LOS DEMÁS USUARIOS QUE VAYAN A FORMAR PARTE DEL PROYECTO</label>
                        <textarea name="project_integrantes" form="frm-project" cols="30" rows="10" class="form-control">
