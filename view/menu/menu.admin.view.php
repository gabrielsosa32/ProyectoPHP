<nav class="navbar navbar-expand-md bg-dark navbar-dark justify-content-center fixed-top">
    ...
    <div class="collapse navbar-collapse justify-content-center" id="collapsibleNavbar">
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-item-custom-1 nav-link" href="?c=project&a=Edit">NUEVO PROYECTO</a>
        </li>
        <li class="nav-item">
          <a class="nav-item-custom-1 nav-link" href="?c=school">ADMINISTRAR ESCUELAS</a>
        </li>
        <li class="nav-item">
          <a class="nav-item-custom-1 nav-link" href="?c=user">ADMINISTRAR USUARIOS</a>
        </li>
